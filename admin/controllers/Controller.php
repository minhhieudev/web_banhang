...
if(isset($_GET["c"])){
    $nameView=$_GET["c"];
        switch($_GET["c"]){
        case "dondathang":
            require_once "admin/models/M_don_dat_hang.php";
            ...
            require_once "admin/views/V_home.php";
        break;
        case "sanpham":
            require_once "admin/models/M_san_pham.php";
        ...
        break;
        case "user":
            require_once "admin/models/M_user.php";
            $M_user=new M_user();
            if(isset($_GET["a"])){
                switch($_GET["a"]){
                   case 'themuser':
        ...
        break;
        case "thongbao":
            require_once "admin/models/M_thong_bao.php";
        ...
        break;
        case "slider":
            require_once "admin/models/M_slider.php";
        ...
        break;
        case "nganhhang":
            require_once "admin/models/M_nganh_hang.php";
