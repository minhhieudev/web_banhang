...
<div class="divright">
      ...
      <div class="content">
            <?php 
                ...
                switch($nameView){
                   case 'dondathang':
                     require_once "admin/views/V_don_dat_hang.php";
                   break;
                   case 'sanpham':
                     require_once "admin/views/V_san_pham.php";
                   break;
                   case 'user':
                     require_once "admin/views/V_user.php";
                   break;
                   case 'thongbao':
                     require_once "admin/views/V_thong_bao.php";
                   break;
                   case 'slider':
                     require_once "admin/views/V_slider.php";
                   break;
                   case 'nganhhang':
                     require_once "admin/views/V_nganh_hang.php";
                   break;
                   default:
                     require_once "admin/views/V_dashboard.php";
                   break;
                }
            ?>
      </div>
